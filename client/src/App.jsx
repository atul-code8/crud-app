...
function App() {
  ...
  const updateItem = async (id) => {
    const response = await axios.put(`${url}/items/${id}`, {
      name,
      description,
    });
  ...
  return (
    <div className="App">
      <h1 style={{ textAlign: "center" }}>Create your notes 📒</h1>
      <form onSubmit={handleSubmit}>
        ...
        <textarea
          ...
          required
        />
        <button type="submit" style={{backgroundColor: '#ccc'}}>{editing ? "Update" : "Add"}</button>
      </form>
      <section
        style={{
          display: "flex",
